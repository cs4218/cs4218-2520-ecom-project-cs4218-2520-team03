...
//const USER_PASSWORD = '123456';
//
//const TARGET_VUS = 1400; // change this for each run: 600, 1000, 1400, 1600, 1800
//const HOLD_SECONDS = 180;
//const GRACEFUL_STOP = '45s';
//
//const scenarioName = `vus_${String(TARGET_VUS).padStart(3, '0')}`;
//
//const loginResponseTime = new Trend(`login_response_time_${scenarioName}`);
//const loginFailRate = new Rate(`login_failed_${scenarioName}`);
//
//export const options = {
//  scenarios: {
//    [scenarioName]: {
